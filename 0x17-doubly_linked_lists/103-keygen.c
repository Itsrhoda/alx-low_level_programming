...
int main(int argc, char **argv)
{
	...
	for (len = 0; argv[1][len]; len++)
		;
	/*_ _ _ _ _ _ _f1_ _ _ _ _ _ _*/
	keygen[0] = ((char *)alph)[(len ^ 59) & 63];
	/*_ _ _ _ _ _ _f2_ _ _ _ _ _ _*/
	ch = vch = 0;
	while (vch < len)
	{
		ch = ch + argv[1][vch];
	...
	/*_ _ _ _ _ _ _f4_ _ _ _ _ _ _*/
	keygen[3] = ((char *)alph)[f4(argv[1], len)];
	/*_ _ _ _ _ _ _f5_ _ _ _ _ _ _*/
	keygen[4] = ((char *)alph)[f5(argv[1], len)];
	/*_ _ _ _ _ _ _f6_ _ _ _ _ _ _*/
